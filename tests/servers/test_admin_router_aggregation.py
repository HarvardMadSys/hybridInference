...
def test_admin_router_has_expected_route_count() -> None:
    ...
    # users/turn-averages, users/ask-question-fractions, users/providers, usage-insights/analyze,
    ...
    # 110 -> 111: recent-requests/performance, the per-(model, endpoint) TTFT
