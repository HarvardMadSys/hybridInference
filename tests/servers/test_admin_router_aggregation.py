...
def test_admin_router_has_expected_route_count() -> None:
    ...
    """
    expected = 86  # includes role-quota, provider-key verification/probe
    ...
    # provider-route model creation, alert-snooze GET/POST/DELETE,
    # site-updates CRUD routes (regenerate-api-key removed in #733),
    # users/turn-averages, usage-insights/analyze, and the per-user +
    # bulk users automation-score routes
