...
Usage:
    ...
    python scripts/cloudflare/d1_scale_test.py --users 100 --concurrency 20

    # Full scale test (1000 users, 1000 concurrent auth lookups)
    python scripts/cloudflare/d1_scale_test.py --users 1000 --concurrency 50

    # Auth hot-path only (skip user creation, use existing data)
    python scripts/cloudflare/d1_scale_test.py --auth-only --users 1000 --concurrency 50

    # Clean up after test
    python scripts/cloudflare/d1_scale_test.py --cleanup
