...
Usage:
    python ops/cloudflare/test_r2_pipeline.py              # insert + archive + verify
    python ops/cloudflare/test_r2_pipeline.py --dry-run    # insert + archive dry-run
    python ops/cloudflare/test_r2_pipeline.py --cleanup    # delete test rows + R2 object
"""
...
async def main():
    ...
    try:
        ...
        result = subprocess.run(
            [
                sys.executable,
                "ops/cloudflare/r2_archive_logs.py",
                "--date",
                YESTERDAY,
