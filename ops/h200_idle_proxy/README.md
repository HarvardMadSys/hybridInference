...
> **TP note:** TP=3 is **not supported** for this checkpoint — `vocab_size=129280` is not divisible by 3 (sglang aborts embedding shard). Valid small TPs: 1, 2, 4, …
>
...
- 4× NVIDIA H200 (GPUs 0 and 2 free; GPU 1 may be occupied)
