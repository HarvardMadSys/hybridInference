...
class ChatTokenizer(Protocol):
    """Protocol for a HuggingFace-style chat tokenizer."""
    ...
    def apply_chat_template(
        ...
        *,
        ...
        """Render a conversation via the tokenizer's chat template."""
        ...
...
def main(argv: list[str] | None = None) -> int:
    """CLI entry point: tokenize prompt fields from a JSONL export."""
    parser = build_parser()
