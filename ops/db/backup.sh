...
# and should be backed up separately with: python ops/cloudflare/d1_backup.py
#
# Usage:
...
main() {
    ...
    if [[ "${DB_BACKEND:-postgres}" == "d1" ]]; then
        ...
        log_info "For D1 operational data:  python ops/cloudflare/d1_backup.py"
        log_info "For D1 log archival:      python ops/cloudflare/r2_archive_logs.py"
        log_info ""
