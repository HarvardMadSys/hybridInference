...
#
# Examples:
#   ./ops/db/restore.sh --backup-dir ./backups/backup_20241114_120000
#   ./ops/db/restore.sh --postgres-only --backup-dir ./backups/backup_20241114_120000
#
