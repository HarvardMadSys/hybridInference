...
```
Expected output: `On branch jason/claude/openrouter-upstream`, working tree clean (the only files present should be the cherry-picked spec at `docs/superpowers/specs/2026-05-02-openrouter-upstream-design.md` and this plan).
