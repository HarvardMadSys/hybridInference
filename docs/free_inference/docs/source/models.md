...
| `minimax-m2.7` | MiniMax M2.7 | 205K tokens | 131K tokens | Function calling, Structured output |
...
The following models are configured for internal users only and may not appear in the public model picker:

| Model ID | Name | Context Length | Max Output | Features |
|----------|------|----------------|------------|----------|
| `claude-sonnet-4.6` | Claude Sonnet 4.6 | 200K tokens | 64K tokens | Function calling, Structured output, Multimodal (text+image) |
| `claude-opus-4.6` | Claude Opus 4.6 | 200K tokens | 128K tokens | Function calling, Structured output, Multimodal (text+image) |
| `claude-opus-4.7` | Claude Opus 4.7 | 1M tokens | 128K tokens | Function calling, Structured output, Multimodal (text+image) |
| `gpt-5.5` | GPT-5.5 | 1.05M tokens | 128K tokens | Function calling, Structured output, Multimodal (text+image) |
